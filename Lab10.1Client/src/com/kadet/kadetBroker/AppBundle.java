...
import com.kadet.kadetBroker.command.GetAllStocksCommand;
...
//            fillDataModel(dataModel);
            ...
            if (!dispatcher.hasAllCustomersInModel()) {
                GetAllCustomersCommand customersCommand = (GetAllCustomersCommand) CommandManager.getInstance().newCommand(Strings.GET_ALL_CUSTOMERS_COMMAND);
                CommandManager.getInstance().executeCommand(customersCommand);
            }
...
//            allCustomersController.setCurrentCustomerTO(allCustomersViewCustomer);
            ...
            if (!dispatcher.hasAllStocksInModel()) {
                GetAllStocksCommand stocksCommand = (GetAllStocksCommand) CommandManager.getInstance().newCommand(Strings.GET_ALL_STOCKS_COMMAND);
                CommandManager.getInstance().executeCommand(stocksCommand);
            }
