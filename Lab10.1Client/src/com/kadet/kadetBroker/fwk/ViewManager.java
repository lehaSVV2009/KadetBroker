...
public class ViewManager {
    ...
    public void notifyByObjectChanged (TO to) {
        ...
        for (TO toFromMap : subscribers.keySet()) {
    ...
    public void addModelChangeListener (ModelChangeListener listener, Object objectForListener) {
    	modelChangeListeners.add(listener);
    }
    
    public void notifyModelChangeListener (Object changedObject) {
    	for (ModelChangeListener modelChangeListener : modelChangeListeners) {
    		modelChangeListener.handleModelChange(changedObject);
		}
    }
