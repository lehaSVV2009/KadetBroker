    ...
    public TO getTOFromDBAnswer (ResultSet resultSet) throws KadetException {
        ...
        try {
            while (resultSet.next()) {
                ...
                stockTO.setSymbol(resultSet.getString(/*Strings.SHARES_TABLE + '.' +*/ Strings.SHARE_SYMBOL));
                shareTO.setQuantity(resultSet.getInt(/*Strings.SHARES_TABLE + '.' + */Strings.SHARE_QUANTITY));
                stockTO.setPrice(resultSet.getFloat(/*Strings.STOCKS_TABLE + '.' +*/ Strings.STOCK_PRICE));
